...
class ConversationViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def get_queryset(self):
        ...
        try:
            ...
            logger.error(f"Error in ConversationViewSet.get_queryset: {str(e)}")
            return Conversation.objects.none()
    ...
    def retrieve(self, request, *args, **kwargs):
        try:
            ...
            logger.error(f"Error in ConversationViewSet.retrieve: {str(e)}")
    ...
    def messages(self, request, pk=None):
        try:
            ...
            logger.error(f"Error in ConversationViewSet.messages: {str(e)}")
    ...
    def send_message(self, request, pk=None):
        try:
            ...
            logger.error(f"Error in ConversationViewSet.send_message: {str(e)}")
    ...
    def end_relay(self, request, pk=None):
        try:
            ...
            logger.error(f"Error in ConversationViewSet.end_relay: {str(e)}")
    ...
    def active_conversations(self, request):
        try:
            ...
            logger.error(f"Error in ConversationViewSet.active_conversations: {str(e)}")
